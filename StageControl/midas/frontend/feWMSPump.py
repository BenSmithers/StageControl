...
from StageControl.gui.constants import HOST, USER, PASSWORD, PORT, KEY
...
class PumpConnection(midas.frontend.EquipmentBase):
    ...
    def readout_func(self):
        ...
        try:
            ...
            self.client.odb_set("/Equipment/PumpConnection/Variables/Sensors", ret_dat, True)
    ...
    def detailed_settings_changed_func(self, path, idx, new_value):
        if path=="/Equipment/PumpConnection/Settings/pumpstate":
            self.set_pump(idx, new_value) 
        elif path=="/Equipment/PumpConnection/Settings/svstate":
            self.set_sv(idx, new_value)  
        elif path=="/Equipment/PumpConnection/Settings/bvstate":
