...
class Ui_Form(object):
    def setupUi(self, Form):
       ...
       # self.drain_button.setEnabled(False)
        ...
        self.temp_label_3 = QtWidgets.QLabel(Form)
        self.temp_label_3.setObjectName("temp_label_3")
        self.temp_value_3 = QtWidgets.QLabel(Form)
        self.temp_value_3.setObjectName("temp_value_3")
        self.temp_value_3.setText("0.0")
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.temp_label_3)
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.temp_value_3)
        ...
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.flow1)
        ...
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.FieldRole, self.flow2)
        ...
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.FieldRole, self.flow3)
        ...
        self.formLayout.setWidget(12, QtWidgets.QFormLayout.FieldRole, self.flow4)
        ...
        self.formLayout.setWidget(13, QtWidgets.QFormLayout.FieldRole, self.flow5)
        ...
        self.formLayout.setWidget(16, QtWidgets.QFormLayout.FieldRole, self.lightlcdNumber_4)
        ...
        self.formLayout.setWidget(18, QtWidgets.QFormLayout.LabelRole, self.water1_lbl)
...
#        self.water_lvl1.setText("Water Level 1")
        self.formLayout.setWidget(18, QtWidgets.QFormLayout.FieldRole, self.water_lvl1)
        ...
        self.formLayout.setWidget(19, QtWidgets.QFormLayout.LabelRole, self.water2_lbl)
...
#        self.water_lvl2.setText("Water Level 2")
        self.formLayout.setWidget(19, QtWidgets.QFormLayout.FieldRole, self.water_lvl2)
        ...
        self.formLayout.setWidget(21, QtWidgets.QFormLayout.FieldRole, self.relaunch_button)
    ...
    def retranslateUi(self, Form):
        ...
        self.temp_label_2.setText(_translate("Form", "Lower Tube"))
        self.temp_label_3.setText(_translate("Form", "Upper Tube"))
        self.temp_value_1.setText(_translate("Form", "0"))
        self.temp_value_2.setText(_translate("Form", "0"))
        self.temp_value_3.setText(_translate("Form", "0"))
